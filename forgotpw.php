...
*/
	...
	else
	{
		...
		if (mysql_num_rows($result) != 1)
			$msg = "<span style='color:red;'>This email is not registered</span>";
		else
		{
			...
			else
			{
				...
				$to = $email;
				$subject = "Welcome to FunZap - Password Reset";
				...
				$message .= "<h4>Your password has been <b>temporarily</b> reset to the number below.<br><br>";
